...
**Link do Desafio Original:** `https://roadmap.sh/projects/server-stats`
Para mais detalhes sobre o desafio: [Server Stats Tool - roadmap.sh](https://roadmap.sh/projects/server-stats)
